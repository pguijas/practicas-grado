...
public class ClientInscriptionDto {
    ...
    public ClientInscriptionDto(Long inscriptionId, Long runId, String runnerEmail, String inscriptionDate, String creditCardNumber, float price, int dorsal, boolean dorsalPicked){
