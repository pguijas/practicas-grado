...
#include "list.h"	//Lista almacena reservas memoria
...
//Recordar:
// leer bien enunciados (cuando no esta la di muestra todas)
//  acer las 3 direcciones * 3
//	mem sin argumentos
//	isprint pa capar errror de bytes largos extraños
...
//mac:%10llu %s %3u %10s %10s %10llu %s %s
void info(char * file){
	struct stat statbuf;
	char * f_mod;
